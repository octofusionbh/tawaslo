    ...
    <main className="tw-overview" dir={ar ? "rtl" : "ltr"}>
      ...
      <div className="ov-main-grid">
        <section className="ov-performance" aria-labelledby="ov-performance-title">
          ...
          <svg className="ov-chart" viewBox="0 0 558 212" role="group" aria-label={live ? t("Performance chart. Each point can be focused for its value.", "رسم الأداء. اختر نقطة لعرض قيمتها.") : t("Sample performance chart. Each point can be focused for its value.", "رسم أداء تجريبي. اختر نقطة لعرض قيمتها.")}>
